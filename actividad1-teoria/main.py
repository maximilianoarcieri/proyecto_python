...
games_categories = ['ACTION','ADVENTURE','ARCADE','BOARD','CARD','CASINO','CASUAL','EDUCATIONAL','MUSIC','PUZZLE','RACING','ROLE PLAYING','SIMULATION','SPORTS','STRATEGY','TRIVIA','WORD']
...
def create_layout():
    ...
    layout = [[sg.Text('Datos disponibles \npara analizar', font = '_ 20', relief = sg.RELIEF_RIDGE, justification = 'center', background_color = '#6E402A')],
            ...
            [sg.Button('Canciones de Spotify', size = (16,1), button_color = '#6E402A'), sg.Input('Artista', size = (12,1), key = 'artist')],
